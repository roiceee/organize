...
function createProjectListItem(project) {
  const element = `<div class="project-li rounded mx-auto mx-sm-0 gx-0 col p-2 bg-primary bg-opacity-25 position-relative" data-project-li="${project.index}" id="project-li-${project.index}">
