...
function createProjectListItem(project) {
   const element = `<div class="project-li card mx-auto mx-sm-0 gx-0 col p-2 bg-primary bg-opacity-50 text-center" data-project-li="${project.index}" id="project-li-${project.index}"><h3>${project.name}</h3></div>`
