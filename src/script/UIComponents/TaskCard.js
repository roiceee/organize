export default function createTaskCard(task) {
    ...
    div.classList.add("card", "mx-auto", "mx-sm-0", "shadow", "gx-0");
    div.setAttribute("data-task-number", `${task}`);
    ...
    div.innerHTML = 
                    ...
                    <div class="p-1 d-flex justify-content-end align-items-center gap-4">
                        <button type="button" data-key="${task.index}" id="delete-button-${task.index}" class="delete-button float-end p-1 col-2">
