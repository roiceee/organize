...
function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    <div className="rounded-2 border border-1 bg-white d-flex p-0 gap-2" style={{maxWidth: "500px"}}>
      ...
      <div>
        ...
        <div>Priority: {task.priority === "" ? "Not specified" : _.capitalize(task.priority)}</div>
      </div>
    </div>
  );
}
